...
def train_baseline(
    ...
    device: torch.device,
    config: Dict,
) -> Tuple[TransformerModel, Dict[str, list]]:
    """Train a baseline Transformer with absolute positional encoding."""
    ...
    for epoch in range(1, config["epochs"] + 1):
        ...
        prefix = f"[{run_label}][Baseline]" if run_label else "[Baseline]"
        print(
